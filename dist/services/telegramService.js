...
export async function sendReminder(reservation) {
    await sendTelegramMessage(reservation.chat_id || DEFAULT_CHAT_ID || '', `⏰ Recordatorio: Tu cita de ${reservation.service_name} es a las ${formatAppointment(reservation.start_iso)}.`);
}
